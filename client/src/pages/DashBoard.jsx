      ...
      <div className="shadow py-4">
        <div className="px-5 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <p className="max-sm:hidden">Welcome, Nk Vision</p>
            <div className="relative group">
              <img src={assets.company_icon} className="w-8 border border-amber-100 rounded-full" alt="" />
            
            <div className="absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12 ">
              <ul className="list-none m-0 p-2 bg-white rounded-md border border-amber-100 text-sm">
